...
OUTPUT_DIR = "/Users/hdon/Projects/Firebase/real-time/bsky-firehose/python/bsky/datasets/needs_help_v2_/v3/has_pledge"
...
def process_file(input_file, output_file):
    ...
    with open(input_file, "r", encoding="utf-8") as infile, \
         open(output_file, "w", encoding="utf-8") as outfile:  # 'w' mode handles fresh writes cleanly
